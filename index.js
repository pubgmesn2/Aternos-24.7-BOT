...
// تعديل البيانات هنا مباشرة لتناسب سيرفرك
...
const botUsername = process.env.BOT_USERNAME || 'Volt_Helper_247';
const minecraftVersion = process.env.MC_VERSION || false; // سيقوم بالتعرف التلقائي على إصدار السيرفر
